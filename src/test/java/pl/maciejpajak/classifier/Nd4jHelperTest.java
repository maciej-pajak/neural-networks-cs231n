...
public class Nd4jHelperTest {
    ...
    public void getSpecifiedElements() {
        ...
        // 4 5 6 7
        // 8 9 10 11
        assertEquals(Nd4j.create(new double[] {2, 7, 9}, new int[]{3, 1}), Nd4jHelper.getSpecifiedElements(array, columnIndexes));
    }
    ...
    public void getSpecifiedElementsLoop() {
        INDArray array = Nd4j.linspace(0, 11, 12).reshape(3,4);
        INDArray columnIndexes = Nd4j.create(new double[] {2, 3, 1}, new int[] {1, 3});
        assertEquals(Nd4j.create(new double[] {2, 7, 9}, new int[]{3, 1}), Nd4jHelper.getSpecifiedElementsLoop(array, columnIndexes));
    }
