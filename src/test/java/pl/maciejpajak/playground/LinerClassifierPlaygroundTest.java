...
public class LinerClassifierPlaygroundTest {
    ...
    public void l() {
        ...
        LinearClassifier.LossFunction.SVM.loss(x.transpose(),y,W.transpose(), 0);
//        assertEquals(16.86, LinerClassifierPlayground.L(W, y, x.transpose()), 0.01);
        Pair<Double, INDArray> resNaive = LinearClassifier.LossFunction.SVM_NAIVE.loss(x.transpose(),y,W.transpose(),0);

        Pair<Double, INDArray> resVec = LinearClassifier.LossFunction.SVM.loss(x.transpose(),y,W.transpose(),0);
